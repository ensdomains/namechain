    ...
    ERC165
{
    ...
    uint256 internal constant _SLOT_RD_ENTRIES = 0;

    /// @dev `GatewayRequest` exit code which indicates no resolver was found.
    uint8 internal constant _EXIT_CODE_NO_RESOLVER = 2;
    ...
    // solhint-disable ordering/ordering
    ...
    // solhint-enable ordering/ordering

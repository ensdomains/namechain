...
library DNSTXTParser {
    ...
    bytes1 internal constant CH_BACKSLASH = bytes1(0x5C); // "\"
    bytes1 internal constant CH_QUOTE = "'";
    bytes1 internal constant CH_SPACE = " ";
    bytes1 internal constant CH_EQUAL = "=";
    bytes1 internal constant CH_ARG_OPEN = "[";
    bytes1 internal constant CH_ARG_CLOSE = "]";

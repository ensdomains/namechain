...
contract MockEjectionController is IL1EjectionController {
    ...
    function migrateToNamechain(uint256 tokenId, address l2Owner, address l2Subregistry, bytes memory data)
        external
        override
    {
    ...
    function completeEjection(uint256, address, address, uint32, uint64, bytes memory) external override {}

 ...
 * between L1 and L2. The controller is responsible for cross-chain communication.
 */
interface IL1EjectionController {
     ...
     * @param tokenId The token ID of the name being migrated
     * @param l2Owner The address that will own the name on L2
     * @param l2Subregistry The subregistry address to use on L2 (optional)
     */
    function initiateL1ToL2Migration(
        uint256 tokenId,
        address l2Owner,

...
contract L2BridgeController is EjectionController, ITokenObserver {
    ...
    /// @notice Should be called when a name is being ejected back to L2.
    ///
    ...
    /// @notice Override onERC1155Received to handle minting scenarios
    ///
    /// @dev When from is address(0), it's a mint operation and we should just return success

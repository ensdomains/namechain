...
/// @notice Interface for the ENSv2 registry datastore, which stores subregistry and resolver addresses and flags
///         for all names, keyed by registry address and label hash.
///
/// @dev The lower 32 bits of label hashes are masked out for storage and retrieval, allowing these bits to be used

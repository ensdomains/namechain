...
contract SingleNameResolver is OwnableUpgradeable, IERC165 {
    ...
    // The namehash of the name this resolver is associated with
    ...
    /**
     * @dev Returns the namehash of the name this resolver is associated with
     * @return The namehash of the associated name
     */

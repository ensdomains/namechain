...
import {LowLevelCallUtils} from "ens-contracts/utils/LowLevelCallUtils.sol";
import {ENS} from "ens-contracts/registry/ENS.sol";
import {IExtendedResolver} from "ens-contracts/resolvers/profiles/IExtendedResolver.sol";
import {Resolver, INameResolver, IAddrResolver} from "ens-contracts/resolvers/Resolver.sol";
...
contract UniversalResolver is ERC165, Ownable {
    ...
    function _resolve(
        ...
        if (resolverAddress.code.length == 0) {

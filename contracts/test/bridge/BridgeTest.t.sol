...
contract BridgeTest is Test, EnhancedAccessControl, RegistryRolesMixin {
    ...
    function testL1BridgeMigrationEvents() public {
        ...
        MigrationData memory migrationData =
            MigrationData({transferData: transferData, toL1: false, data: abi.encode("additional migration data")});
        ...
        (bytes memory decodedDnsEncodedName, MigrationData memory decodedMigrationData) =
            BridgeEncoder.decodeMigration(eventMessage);

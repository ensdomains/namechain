...
contract NameUtilsTest is Test {
    ...
    function test_dnsEncodeEthLabel_HashedLabelFormat() public view {
        ...
        string memory hashedLabel = "[af2caa1c2ca1d027f1ac823b529d0a67cd144264b2789fa2ea4d63a67c7103cc]";
        ...
        string memory malformedHashed = "[af2caa1c2ca1d027f1ac823b529d0a67cd144264b2789fa2ea4d63a67c7103]";
    ...
    function test_boundary_ConsecutiveExtractions() public view {
        ...
        for (uint i = 0; i < expectedLabels.length; i++) {
            (string memory extractedLabel, uint256 nextOffset) = _wrapper.extractLabel(multiLabelDns, currentOffset);

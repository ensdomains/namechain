...
contract LibLabelWrapper {
    ...
    function extractLabel(
        ...
        return LibLabel.extractLabel(dnsEncodedName, offset);
    }

    function extractLabel(bytes memory dnsEncodedName) external pure returns (string memory) {
        return LibLabel.extractLabel(dnsEncodedName);
    }
}

contract LibLabelTest is Test {
    LibLabelWrapper _wrapper;

    function setUp() public {
        _wrapper = new LibLabelWrapper();
    }

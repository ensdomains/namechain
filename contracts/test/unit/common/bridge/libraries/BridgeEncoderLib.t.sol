...
contract BridgeEncoderWrapper {
    ...
    ) external pure returns (bytes memory dnsEncodedName, TransferData memory data) {
...
contract BridgeEncoderLibTest is Test {
    ...
    function testEncodeEjection() public view {
        ...
        bytes memory dnsEncodedName = NameIdLib.dnsEncodeEthLabel("test");
    ...
    function testEncodingStructure() public view {
        ...
        bytes memory dnsEncodedName = NameIdLib.dnsEncodeEthLabel("structuretest");
        bytes memory encodedMessage = BridgeEncoderLib.encodeEjection(dnsEncodedName, transferData);

...
import {Entrypoint, IRegistry} from "~src/universalResolver/Entrypoint.sol";
import {RegistryDatastore} from "~src/common/registry/RegistryDatastore.sol";

contract EntrypointTest is Test, ERC1155Holder {
    ...
    function test_findRegistries() external {
        ...
        Entrypoint ep = new Entrypoint(NameCoder.encode("eth"), ethRegistry);
        ...
        IRegistry[] memory registries = ep.findRegistries(NameCoder.encode("test.eth"));

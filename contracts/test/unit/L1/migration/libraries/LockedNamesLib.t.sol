...
contract LockedNamesLibTest is Test {
    ...
    function test_generateRoleBitmapsFromFuses_all_permissions() public pure {
        ...
        assertTrue(
            (tokenRoles & RegistryRolesLib.ROLE_SET_TOKEN_OBSERVER) != 0,
            "Token should have ROLE_SET_TOKEN_OBSERVER"
        );
        assertTrue(
            (tokenRoles & RegistryRolesLib.ROLE_SET_TOKEN_OBSERVER_ADMIN) != 0,
        ...
        assertTrue(
            (subRegistryRoles & RegistryRolesLib.ROLE_SET_TOKEN_OBSERVER) == 0,
            "SubRegistry should NOT have ROLE_SET_TOKEN_OBSERVER"
        );
        assertTrue(
            (subRegistryRoles & RegistryRolesLib.ROLE_SET_TOKEN_OBSERVER_ADMIN) == 0,
    ...
    function test_generateRoleBitmapsFromFuses_cannot_burn_fuses_with_restrictions() public pure {
        ...
        uint256 expectedTokenRoles = RegistryRolesLib.ROLE_SET_TOKEN_OBSERVER |
    ...
    function test_generateRoleBitmapsFromFuses_always_includes_token_observer_roles() public pure {
        ...
        (uint256 tokenRoles1, ) = LockedNamesLib.generateRoleBitmapsFromFuses(minimalFuses);
        assertTrue(
            (tokenRoles1 & RegistryRolesLib.ROLE_SET_TOKEN_OBSERVER) != 0,
            "Should have ROLE_SET_TOKEN_OBSERVER with minimal fuses"
        );
        assertTrue(
            (tokenRoles1 & RegistryRolesLib.ROLE_SET_TOKEN_OBSERVER_ADMIN) != 0,
        ...
        uint32 restrictiveFuses = CANNOT_UNWRAP |
            ...
            CANNOT_SET_RESOLVER |
            CANNOT_CREATE_SUBDOMAIN;
        (uint256 tokenRoles2, ) = LockedNamesLib.generateRoleBitmapsFromFuses(restrictiveFuses);
        assertTrue(
            (tokenRoles2 & RegistryRolesLib.ROLE_SET_TOKEN_OBSERVER) != 0,
            "Should have ROLE_SET_TOKEN_OBSERVER with restrictive fuses"
        );
        assertTrue(
            (tokenRoles2 & RegistryRolesLib.ROLE_SET_TOKEN_OBSERVER_ADMIN) != 0,
        ...
        (uint256 tokenRoles3, ) = LockedNamesLib.generateRoleBitmapsFromFuses(frozenFuses);
        assertTrue(
            (tokenRoles3 & RegistryRolesLib.ROLE_SET_TOKEN_OBSERVER) != 0,
            "Should have ROLE_SET_TOKEN_OBSERVER even with CANNOT_BURN_FUSES"
        );
        assertTrue(
            (tokenRoles3 & RegistryRolesLib.ROLE_SET_TOKEN_OBSERVER_ADMIN) != 0,
        ...
        (uint256 tokenRoles4, ) = LockedNamesLib.generateRoleBitmapsFromFuses(allPermissionFuses);
        assertTrue(
            (tokenRoles4 & RegistryRolesLib.ROLE_SET_TOKEN_OBSERVER) != 0,
            "Should have ROLE_SET_TOKEN_OBSERVER with all permissions"
        );
        assertTrue(
            (tokenRoles4 & RegistryRolesLib.ROLE_SET_TOKEN_OBSERVER_ADMIN) != 0,
        ...
        (, uint256 subRegistryRoles) = LockedNamesLib.generateRoleBitmapsFromFuses(anyFuses);
        assertTrue(
            (subRegistryRoles & RegistryRolesLib.ROLE_SET_TOKEN_OBSERVER) == 0,

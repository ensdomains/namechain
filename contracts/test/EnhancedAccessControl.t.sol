...
contract EnhancedAccessControlTest is Test {
    ...
    bytes32 public constant CONTEXT_1 = keccak256("CONTEXT_1");
    bytes32 public constant CONTEXT_2 = keccak256("CONTEXT_2");
    ...
    function test_root_context_role_applies_to_all_contexts() public {
        ...
        assertTrue(access.hasRole(keccak256("ANY_OTHER_CONTEXT"), ROLE_A, user1));
    }
} 
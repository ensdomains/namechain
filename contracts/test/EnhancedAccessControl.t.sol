...
contract EnhancedAccessControlTest is Test, MockRoles {
    ...
    function test_grant_roles_unauthorized_admin() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IEnhancedAccessControl.EACUnauthorizedAccountAdminRoles.selector, RESOURCE_1, ROLE_A, user1
            )
        );
        vm.prank(user1);
    ...
    function test_only_root_roles() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IEnhancedAccessControl.EACUnauthorizedAccountRoles.selector, access.ROOT_RESOURCE(), ROLE_A, user2
            )
        );
        vm.prank(user2);
        access.callOnlyRootRoles(ROLE_A);
    ...
    function test_revoke_root_roles_unauthorized_admin() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IEnhancedAccessControl.EACUnauthorizedAccountAdminRoles.selector, access.ROOT_RESOURCE(), ROLE_A, user1
            )
        );
    ...
    function test_getAssigneeCount_with_root_resource() public {
        ...
        (uint256 rootCounts, uint256 rootMask) = access.getAssigneeCount(access.ROOT_RESOURCE(), ROLE_A);
